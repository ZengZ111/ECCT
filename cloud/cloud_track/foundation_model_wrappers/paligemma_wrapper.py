...
class PaligemmaWrapper(WrapperBase):
    def __init__(
        ...
        model="/home/zz/models/paligemma-3b-mix-224",
        enable_caching=True,
    ...
    def run_inference(self, prompt: str, image: Image):
        ...
        with torch.inference_mode():
            ...
            decoded_output = full_text.replace(prompt, "", 1).strip()

        decoded_output = decoded_output.replace("\n", "")

        yes_no = "undefined"
        text = decoded_output.lower().strip()
...
if __name__ == "__main__":
    ...
    image_path = (
        "/home/zz/workspace/CloudTrack/cloud_track/datasets/sard/gss99.jpg"
    )
