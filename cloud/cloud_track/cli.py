...
def video_demo(
    ...
    yolo_model_path: Annotated[
        str, typer.Option(help="Path to the YOLO model weights file (e.g., yolov8n.pt).")
    ] = "yolov8n.pt",
    overscan_pixels: Annotated[
        int, typer.Option(help="Number of extra pixels to expand the crop around the detected object for VLM context.")
    ] = 50,
):
    """
    Run the [blue]command line demo[/blue] with local YOLO detection. :boom:
    """
    ...
    run_video_demo(
        ...
        yolo_model_path=yolo_model_path,      # 新增
        overscan_pixels=overscan_pixels,      # 新增
    )
